...
class _DocAllDetailsState extends State<DocAllDetails> {
  ...
  //             'id': widget.docKaId,
  //             'content':
  //             'Thanks for Consulting! $name, for further detailed assessments please send me your last 5 year medical history(if any) and your current predicted disease(if you opted for it). We\'be connecting shortly for further process. ',
  //             'chatId': newChat['_id']
  //           }));
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    //             chatId: newChat['_id'], pic: widget.image, name: widget.name)));
